...
var FantasyMap = {
    ...
    options: {
        ...
        image: {
            width: 9761,
            height: 6833,
            TilesUrl: '@Url.Content("~/ValtharMap/tiles")',
            meterPerPixel: 582.860965217,
            attribution: 'Map data: Michael Stebbings'
        },

        data: {
            '@Url.Content("~/ValtharMap/data/Capitals.json")': 'Capitals',
            '@Url.Content("~/ValtharMap/data/Cities.json")': 'Cities',                
            '@Url.Content("~/ValtharMap/data/TownsVillages.json")': 'Towns/Villages',
            '@Url.Content("~/ValtharMap/data/Ruins.json")': 'Ruins',
            '@Url.Content("~/ValtharMapdata/SmallGeographicFeatures.json")': 'Small Features'
            //'~/ValtharMap/data/Faerun/Sites.json': 'Sites',
            //'~/ValtharMap/data/Faerun/Fortresses.json': 'Fortresses',
            //'~/ValtharMap/data/Faerun/Ruins.json': 'Ruins'
        },
    ...
    openWikiLink: function (title) {
        ...
        .fail(function (jqXHR, status, error) {
            sidebar.setContent('An error occurred while processing the request, sorry!');
        });
